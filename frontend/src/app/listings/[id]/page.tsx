...
async function getListing(id: string) {
    ...
    return {
        ...
        guide: guide ? {
            fullName: guide.user?.fullName || guide.user?.name || "Rehber",
            city: guide.user?.city || "İstanbul",
            bio: guide.user?.bio || "",
            phone: showPhone ? (guide.user?.phone || null) : null,
            isIdentityVerified: guide.user?.isIdentityVerified || false,
            photo: guide.user?.photo || null,
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                                    <div className="bg-gray-50 rounded-xl p-4 border text-center">
                                        ...
                                        <div className="text-xl font-bold text-gray-900">{listing.pricing?.quad?.toString() || '-'} SAR</div>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-4 border text-center">
                                        <div className="text-gray-500 text-sm mb-1">3 Kişilik Oda</div>
                                        <div className="text-xl font-bold text-gray-900">{listing.pricing?.triple?.toString() || '-'} SAR</div>
                                    </div>
                                    <div className="bg-gray-50 rounded-xl p-4 border text-center">
                                        <div className="text-gray-500 text-sm mb-1">2 Kişilik Oda</div>
                                        <div className="text-xl font-bold text-gray-900">{listing.pricing?.double?.toString() || '-'} SAR</div>
                                    </div>
                                </div>
                            </div>
