        ...
        <div className="container py-16 md:py-24 max-w-4xl mx-auto space-y-12">
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
                ...
                <ul>
                    ...
                    <li>Listelenen turların gerçekleştirilmesi, vize alımı, otel kalitesi ve uçuş rötarları gibi süreçlerde hukuki muhatap <strong>ilÃ¢n sahibi acentedir</strong>.</li>
