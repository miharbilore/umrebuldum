...
export class TokenService {
    ...
    static async consumeTokens(
        ...
        const executionClient = tx ? async (work: (txClient: Prisma.TransactionClient) => Promise<any>) => work(tx) : (work: (txClient: Prisma.TransactionClient) => Promise<any>) => prisma.$transaction(work, { isolationLevel: 'RepeatableRead' });
